const translations = {
    'en-US': {
        ...
        'intro_welcome': 'WELCOME {name} TO ASSETS HUB!',
        'intro_guide_overview': 'Now that your account is created, this quick guide shows you the hub sections as an example. It appears only once and then the hub opens normally.',
        'intro_guide_details': 'This example explains the asset card, preview controls, settings and version archive.',
        'intro_guide_asset': 'Asset card: open the release module and view details.',
        'intro_guide_preview': 'Media preview: play the video or enlarge the image.',
        'intro_guide_settings': 'Settings: choose English or Español and keep it next time.',
        'intro_guide_versions': 'Versions: store old builds inside version folders.',
        'intro_example_label': 'Example asset panel',
        'intro_example_title': "Sol's RNG V0.1",
        'intro_example_desc': 'Preview the main build, watch the demo, and download the current release.',
    ...
    'es-LA': {
        ...
        'intro_welcome': 'BIENVENIDO {name} AL HUB DE ACTIVOS!',
        'intro_guide_overview': 'Ahora que tu cuenta está creada, esta guía rápida muestra las secciones del hub como ejemplo. Aparece solo una vez y luego el hub se abre normalmente.',
        'intro_guide_details': 'Este ejemplo explica la tarjeta de activos, los controles de vista previa, los ajustes y el archivo de versiones.',
        'intro_guide_asset': 'Tarjeta de activo: abre el módulo de lanzamiento y ve los detalles.',
        'intro_guide_preview': 'Vista previa de medios: reproduce el video o amplía la imagen.',
        'intro_guide_settings': 'Ajustes: elige English o Español y mantenlo para la próxima vez.',
        'intro_guide_versions': 'Versiones: guarda builds anteriores en carpetas de versiones.',
        'intro_example_label': 'Panel de activo de ejemplo',
        'intro_example_title': 'Sol\'s RNG V0.1',
        'intro_example_desc': 'Previsualiza la build principal, mira la demo y descarga la versión actual.',
...
function runIntroSequence(name) {
    ...
    const template = translations[currentLang]['intro_welcome'] || 'WELCOME {name} TO ASSETS HUB!';
    const full = template.replace('{name}', name.toUpperCase());
    const msPerChar = 45;
